...
mixin _$AppStore on _AppStore, Store {
  ...
  Future<void> setLanguage(String aSelectedLanguageCode) {
    return _$setLanguageAsyncAction.run(() => super.setLanguage(aSelectedLanguageCode));
  }
  ...
  void setFullName(String? name) {
    final _$actionInfo = _$_AppStoreActionController.startAction(name: '_AppStore.setFullName');
    try {
  ...
  void setAdmin(bool val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(name: '_AppStore.setAdmin');
    try {
  ...
  void setSuperAdmin(bool val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(name: '_AppStore.setSuperAdmin');
    try {
